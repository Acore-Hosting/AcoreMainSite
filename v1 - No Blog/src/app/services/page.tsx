...
export default function ServicesPage() {
  ...
  useEffect(() => {
    document.title = "Acore Hosting \u2022 Services";
    ...
    <>
      ...
      <div className="w-screen min-h-screen flex flex-col items-center justify-center px-5 pt-24">
        <div className="max-w-5xl mx-auto text-center mb-16" data-aos="fade-up">
          <div className="glass-card px-4 py-1.5 rounded-full inline-block text-sm font-semibold text-[#22c55e] mb-6">Services</div>
          <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-6">Our <span className="text-[#22c55e]">services</span></h1>
          <p className="text-lg text-neutral-500 dark:text-neutral-400 max-w-xl mx-auto leading-relaxed">High-performance hosting for games, code, and more.</p>
        </div>
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl w-full mx-auto px-5">
          <Link href="/service/minecraft" data-aos="fade-up" className="glass-card !rounded-3xl p-8 flex flex-col items-center text-center hover:scale-[1.02] transition-all duration-300 group">
            <img src="https://cdn.acorehosting.com/branding/plans/minecraft.png" alt="Minecraft" className="h-16 w-16 object-contain mb-6" />
            <h2 className="text-2xl font-black mb-3">Minecraft</h2>
            <p className="text-neutral-500 dark:text-neutral-400 text-sm leading-relaxed mb-6">Low-latency servers with one-click modpack installs and DDoS protection.</p>
            <span className="btn scale bg-[#22c55e] text-[#052e16] font-bold px-8 py-3 rounded-full hover:rounded-2xl transition-all duration-300 text-sm mt-auto">View plans</span>
          </Link>
          <Link href="/service/code" data-aos="fade-up" data-aos-delay="150" className="glass-card !rounded-3xl p-8 flex flex-col items-center text-center hover:scale-[1.02] transition-all duration-300 group">
            <img src="https://cdn.acorehosting.com/branding/plans/bot.svg" alt="Code" className="h-16 w-16 object-contain mb-6" />
            <h2 className="text-2xl font-black mb-3">Code</h2>
            <p className="text-neutral-500 dark:text-neutral-400 text-sm leading-relaxed mb-6">Reliable hosting for bots, APIs, and web apps with one-click GitHub deploys.</p>
            <span className="btn scale bg-[#ec4899] text-white font-bold px-8 py-3 rounded-full hover:rounded-2xl transition-all duration-300 text-sm mt-auto">View plans</span>
          </Link>
          <Link href="/service/hytale" data-aos="fade-up" data-aos-delay="300" className="glass-card !rounded-3xl p-8 flex flex-col items-center text-center hover:scale-[1.02] transition-all duration-300 group">
            <img src="https://cdn.acorehosting.com/branding/plans/hytale.png" alt="Hytale" className="h-16 w-16 object-contain mb-6" />
            <h2 className="text-2xl font-black mb-3">Hytale</h2>
            <p className="text-neutral-500 dark:text-neutral-400 text-sm leading-relaxed mb-6">Pre-configured Hytale servers with mod support and instant setup.</p>
            <span className="btn scale bg-[#3b82f6] text-white font-bold px-8 py-3 rounded-full hover:rounded-2xl transition-all duration-300 text-sm mt-auto">View plans</span>
          </Link>
        </div>
      </div>
