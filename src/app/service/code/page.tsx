      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div data-aos="fade-up" className="mb-10">
          <div className="glass-card !rounded-2xl px-6 py-4 flex items-center gap-3 border-l-4 border-yellow-500">
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-300">You&apos;ll need to open a ticket on <a href="https://discord.gg/cqT5zpNVEd" className="text-[#ec4899] font-bold hover:underline">Discord</a> to start your purchase. We&apos;ll help you pick the right plan and give you a discount code.</p>
          </div>
        </div>
