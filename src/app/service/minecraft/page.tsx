...
export default function MinecraftPage() {
  useEffect(() => {
    document.title = "Acore Hosting \u2022 Minecraft Hosting";
...
function Header() {
  return (
    <div className="w-screen min-h-screen flex flex-col items-center justify-center px-5 pt-24 bg-cover bg-center bg-no-repeat relative" style={{backgroundImage: "url(https://cdn.acorehosting.com/backgrounds/5.png)"}}>
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10" data-aos="fade-up">
        <div className="glass-card px-4 py-1.5 rounded-full inline-block text-sm font-semibold text-[#22c55e] mb-6">
          Minecraft Hosting
        </div>
        <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-6">
          Powerful Minecraft
          <br />
          <span className="text-[#22c55e]">server hosting</span>
        </h1>
        <p className="text-lg text-neutral-500 dark:text-neutral-400 max-w-xl mx-auto leading-relaxed">
          Low-latency Minecraft servers with one-click modpack installs, DDoS protection, and full FTP access.
        </p>
      </div>
      <div className="flex flex-col sm:flex-row gap-4 mt-10 relative z-10" data-aos="fade-up" data-aos-delay="300">
        <Link href="#plans" className="btn scale tilt bg-[#22c55e] text-[#052e16] px-8 py-4 text-lg font-bold">
          View plans
        </Link>
    ...
    <section id="plans" className="w-screen px-5 py-28">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16" data-aos="fade-up">
          <div className="glass-card px-4 py-1.5 rounded-full inline-block text-sm font-semibold text-[#22c55e] mb-6">Pricing</div>
          <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-4">
            Minecraft plans
          </h2>
          <p className="text-neutral-500 dark:text-neutral-400 max-w-xl mx-auto">
            From a small survival world to a massive network — we&apos;ve got you covered.
          </p>
        </div>
        <div data-aos="fade-up" className="mb-10">
          <div className="glass-card !rounded-2xl px-6 py-4 flex items-center gap-3 border-l-4 border-yellow-500">
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-300">You&apos;ll need to open a ticket on <a href="https://discord.com" className="text-[#22c55e] font-bold hover:underline">Discord</a> to start your purchase. We&apos;ll help you pick the right plan and give you a discount code.</p>
          </div>
        </div>
          ...
          {plans.map((plan, i) => (
            ...
            >
              <div className="glass-card flex-1 h-full flex flex-col gap-6 p-8 rounded-3xl hover:scale-95 transition-transform duration-300 ease-out will-change-transform">
                {plan.popular && (
                  <div className="text-xs font-bold text-[#22c55e] uppercase tracking-widest">Most Popular</div>
                )}
                ...
                <ul className="flex flex-col gap-3 text-base">
                  {[
                    ...
                    <li key={fi} className="flex items-center gap-3">
                      <svg className="h-5 w-5 text-[#22c55e] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={feature.icon} /></svg>
          ...
          <div className="glass-card rounded-3xl px-8 py-6 flex flex-col items-center gap-4 w-full">
            ...
            <div className="flex flex-wrap justify-center gap-8 text-sm">
              <div className="flex items-center gap-3">
                <svg className="h-5 w-5 text-[#22c55e] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" /></svg>
                <span>Up to <span className="font-bold">1024 GB</span> RAM</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="h-5 w-5 text-[#22c55e] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                <span>Up to <span className="font-bold">48 vCPU</span> Cores</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="h-5 w-5 text-[#22c55e] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
                <span>Up to <span className="font-bold">15 TB</span> NVMe SSD</span>
              </div>
            </div>
            <Link href="https://my.acorehosting.com" className="btn scale bg-[#22c55e] text-[#052e16] font-bold px-8 py-3 text-sm rounded-full hover:rounded-2xl transition-all duration-300">
              Buy Now
            </Link>
          </div>
        </div>
  ...
  return (
    <section className="w-screen px-5 py-28 border-t border-neutral-200 dark:border-neutral-800">
      <div className="max-w-3xl mx-auto text-center" data-aos="fade-up">
        <div className="glass-card px-4 py-1.5 rounded-full inline-block text-sm font-semibold text-[#22c55e] mb-6">Free</div>
        <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-4">
          Try Minecraft hosting for free
        </h2>
        ...
        <Link href="/zero" className="btn scale tilt bg-[#22c55e] text-[#052e16] px-10 py-4 text-lg font-bold">
...
function CTA() {
  return (
    <section className="w-screen bg-[#22c55e] px-5 py-28">
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="text-4xl md:text-6xl font-black text-[#052e16] tracking-tight mb-6" data-aos="fade-up">
          Ready to launch your server?
        </h2>
        <p className="text-lg text-[#052e16]/80 max-w-lg mx-auto mb-10" data-aos="fade-up" data-aos-delay="150">
          Get your Minecraft server online in minutes. 30-day money-back guarantee.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center" data-aos="fade-up" data-aos-delay="300">
          <Link href="/contact" className="btn scale tilt bg-[#052e16] text-white font-bold px-10 py-4 text-lg hover:bg-[#0a3d1e] rounded-full hover:rounded-2xl transition-all duration-300">
            Get started today
          </Link>
          <Link href="/" className="btn scale tilt bg-white/20 text-[#052e16] font-bold px-10 py-4 text-lg hover:bg-white/30">
            Back to home
          </Link>
        </div>
      </div>
